...
\begin{jobshort}{2022 - 2026    Diplôme d'Ingénieur en Informatique}{\href{https://www.utc.fr}{UTC}, France}
    Spécialisé en Génie des Systèmes Informatiques. \textbf{Cours principaux :} Algorithmes \& Structures de Données, IA, Machine Learning, Deep Learning, POO, Systèmes d'exploitation, Systèmes distribués, Réseaux, Cybersécurité, etc.
\end{jobshort}
