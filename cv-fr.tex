...
\begin{tabularx}{\linewidth}{@{} C @{}}
    ...
    \href{tel:[redacted]}{\raisebox{-0.05\height}\faMobile \ [redacted]} \\
\end{tabularx}

% \section{Résumé}
Étudiant en ingénierie logicielle à l’UTC, spécialisé en systèmes informatiques, avec un fort intérêt pour l’IA, et passionné par la conception d’architectures efficaces ainsi que le développement d’applications, performantes et à grande échelle.
...
\begin{jobshort}{Enseignant volontaire en association de programmation, UT'Code, Compiègne}{Fév. 2023 - Fév. 2024}
...
\begin{jobshort}{Stagiaire ouvrier, \href{https://www.loreal.com}{L'Oréal Centréal}, Mitry-Mory}{Jan. 2023 - Fév. 2023}
...
\begin{joblong}{Moteur de Recherche de Cours – Application Web SaaS}{\href{https://mohamedtahiri.com/projects/my-biggest-project}{En savoir plus}}
    \item Développement d'un moteur de recherche de cours SaaS avec Next.js, NestJS, PostgreSQL, Supabase, AWS, et Algolia (moteur de filtrage et classement alimenté par IA). Sortie prévue bientôt.
...
\begin{jobshort}{2022 - 2026    Diplôme d'Ingénieur en Informatique}{\href{https://www.utc.fr}{UTC}, France}
    Spécialisé en Génie des Systèmes Informatiques. \textbf{Cours principaux :} Algorithmes \& Structures de Données, IA, Machine Learning, Deep Learning, Data Science, Statistics, POO, Systèmes distribués, Réseaux, Cybersécurité, Web, etc.
\end{jobshort}

\begin{jobshort}{2021 - 2022    Classe Préparatoire aux Grandes Écoles (MPSI)}{Lycée Charlemagne, Paris, France}
\end{jobshort}
...
\begin{tabularx}{\linewidth}{@{}l X@{}}
    \textbf{Data \& AI} & \normalsize{Airflow, NumPy, Pandas, Python, PyTorch, Google Apps Script, Claude Code, Cursor}           \\
