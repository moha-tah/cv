...
% \section{Summary}
Software Engineering student at UTC specializing in Computer Systems, with a strong focus on artificial intelligence, passionate about designing efficient architectures and building intelligent, high-performance, data-driven applications.
...
\begin{jobshort}{Volunteer Programming Club Instructor, UT'Code, Compiègne}{Feb. 2023 - Feb. 2024}
...
\begin{jobshort}{Industrial Discovery Intern, \href{https://www.loreal.com}{L'Oréal Centréal}, Mitry-Mory}{Jan. 2023 - Feb. 2023}
\end{jobshort}
...
\begin{joblong}{Course Search Engine – SaaS Web Application}{\href{https://mohamedtahiri.com/projects/my-biggest-project}{Learn more}}
    \item Developed with Next.js, NestJS, PostgreSQL, Supabase, AWS, and Algolia (AI-powered filtering \& ranking engine). Learnt a lot about how to design a scalable API. Released soon.
...
\begin{jobshort}{2022 - 2026    Software Engineering Master's Degree}{\href{https://www.utc.fr}{UTC} (Sorbonne University), France}
    Specialized in Computer Systems Engineering. \textbf{Main courses:} Algorithms \& Data Structures, AI, Machine Learning, Deep Learning, Data Science, Statistics, OOP, Distributed Systems, Networks, Cybersecurity, Web, etc.
\end{jobshort}

\begin{jobshort}{2021 - 2022    CPGE MPSI - Intensive Foundation Program in Science}{Lycée Charlemagne, Paris, France}
\end{jobshort}
